...
#     ;;
    ...
    do
        ...
        curl "$api/datasets/$dataset_id/resources/${resource_id}/upload/" -F "file=@results/decpv2.${ext}" -H "X-API-KEY: $api_key"
        ...
        curl -X PUT "$api/datasets/$dataset_id/resources/$idDailyResource/" --data '{"type":"update"}' -H "Content-type: results/json" -H "X-API-KEY: $api_key"
    ...
    curl "$api/datasets/$dataset_id/resources/${resource_id_ocds}/upload/" -F "file=@results/decpv2.ocds.json" -H "X-API-KEY: $api_key"
